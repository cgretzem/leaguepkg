...
def set_champions():
    ...
    with open("dragontail-10.25.1/10.25.1/data/en_US/champion.json", "r") as f:
...
def set_items():
    ...
    with open("dragontail-10.25.1/10.25.1/data/en_US/item.json", "r") as f:
...
def set_runes():
    ...
    with open("dragontail-10.25.1/10.25.1/data/en_US/runesReforged.json", "r") as f:
